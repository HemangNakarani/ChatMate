...
public class MessageListAdapterRoom extends RecyclerView.Adapter {
    ...
    public MessageListAdapterRoom(Context context, List<SocketMessage> messageList, String oppositeUid, Integer font) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_MESSAGE_SENT) {
            ...
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_message_receive_room, parent, false);
    ...
    private class ReceivedMessageHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        ReceivedMessageHolder(View itemView) {
            ...
            messageText = itemView.findViewById(R.id.text_message_body_room);
            timeText = itemView.findViewById(R.id.text_message_time_room);
            nameText = itemView.findViewById(R.id.text_message_name_room);
            profileImage = itemView.findViewById(R.id.image_message_profile_room);
            messageText.setOnCreateContextMenuListener(this);
        }
        ...
        void bind(SocketMessage message, final int position) {
            ...
            messageText.setBackgroundColor(color);
